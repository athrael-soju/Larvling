...
- `facts (id TEXT PK, claim TEXT NOT NULL, domain TEXT, tags TEXT, confidence TEXT DEFAULT 'observed', source TEXT, established TEXT DEFAULT date('now'), confirmed TEXT, expires TEXT, notes TEXT)`
